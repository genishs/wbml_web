...
const ROUNDS = [
  { name: 'DEATH MASTER', sky: '#0088ff', boss: 'fly',    hp: 4,   score: 2000,  sword: null, sprite: 'death',        dir: 'LR',
  ...
  { name: 'KING VAMPIRE', sky: '#1f6a3a', boss: 'fly',    hp: 6,  score: 2000,  sword: 'broad',     dir: 'LR',
    ...
    chain: [ { name:'KING VAMPIRE',   type:'fly',    hp:6, score:2000, sword:'broad' , sprite:'vampire'},
             { name:'MYCONID MASTER', type:'ground', hp:8, score:2000, sword:null   , sprite:'myconid'} ],
  ...
  { name: 'RED KNIGHT', sky: '#44506a', boss: 'ground', hp: 20,  score: 3000,  sword: null, sprite: 'redknight',        dir: 'RL',
  ...
  { name: 'KRAKEN', sky: '#0077cc', boss: 'fly',    hp: 24,  score: 3000,  sword: null, sprite: 'kraken',        dir: 'RL',
  ...
  { name: 'GIANT KONG', sky: '#338800', boss: 'ground', hp: 64,  score: 3000,  sword: 'great',     dir: 'LR',
    ...
    chain: [ { name:'GIANT KONG',   type:'ground', hp:64, score:3000, sword:'great' , sprite:'kong'},
             { name:'VAMPIRE BATS', type:'fly',    hp:16, score:2000, sword:null    , sprite:'vampirebats'} ],
  ...
  { name: 'SPHINX', sky: '#aaaa77', boss: 'ground', hp: 84,  score: 3000,  sword: null, sprite: 'sphinx',        dir: 'LR',
  ...
  { name: 'COIN COLLECTOR', sky: '#2ab0ff', boss: 'fly',    hp: 32,  score: 4000,  sword: 'excalibur', dir: 'LR',
    ...
    chain: [ { name:'COIN COLLECTOR', type:'fly',    hp:32, score:4000, sword:'excalibur' , sprite:'coincollector'},
             { name:'BLUE KNIGHT',    type:'ground', hp:64, score:4000, sword:null        , sprite:'blueknight'} ],
  ...
  { name: 'DEMON', sky: '#7a2012', boss: 'ground', hp: 96,  score: 3000,  sword: 'legend',    dir: 'LR',
    ...
    chain: [ { name:'DEMON',      type:'ground', hp:96, score:3000, sword:'legend' , sprite:'demon'},
             { name:'HOB GOBLIN', type:'ground', hp:96, score:4000, sword:null     , sprite:'hobgoblin'} ],
  ...
  { name: 'SNOW KONG', sky: '#88ccee', boss: 'ground', hp: 96,  score: 4000,  sword: null, sprite: 'snowkong',        dir: 'RL',
  ...
  { name: 'SILVER KNIGHT', sky: '#667088', boss: 'ground', hp: 96,  score: 5000,  sword: null, sprite: 'silverknight',        dir: 'LR',
  ...
  { name: 'MEKA DRAGON', sky: '#000066', boss: 'ground', hp: 256, hp2: 192, score: 30000, sword: null, sprite: 'mekadragon', dir: 'LR', final: true,
...
export function buildStage(stageNum) {
  ...
  const chainSpec = round.chain || [{
    name: round.name, type: round.boss, hp: round.hp, score: round.score, sword: round.sword, sprite: round.sprite,
  }];
